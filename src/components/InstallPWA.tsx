          ...
          {showTutorial && (
            <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 sm:p-6" style={{ isolation: 'isolate' }}>
              ...
              <motion.div
                ...
                className="relative w-full max-w-lg bg-zinc-900 border border-white/10 rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] pointer-events-auto"
              >
                {/* Header */}
                <div className="p-6 border-b border-white/5 flex items-center justify-between bg-zinc-900/50">
                  ...
                  <button 
                    onClick={() => setShowTutorial(false)}
                    className="h-10 w-10 flex items-center justify-center rounded-xl bg-white/5 hover:bg-white/10 transition-colors pointer-events-auto"
                  >
                    <X size={20} />
                  </button>
                </div>
                    ...
                    <div className="space-y-6">
                      ...
                      {deferredPrompt && (
                        <button
                          ...
                          className="w-full mt-4 bg-primary hover:bg-primary-hover text-black font-black uppercase tracking-tighter italic py-4 rounded-2xl flex items-center justify-center gap-2 transition-all shadow-xl shadow-primary/20 active:scale-[0.98] pointer-events-auto"
                        >
                          <Download size={20} />
                          Instalar Agora
                        </button>
