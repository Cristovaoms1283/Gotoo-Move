...
import { createHomeWorkout } from "@/app/actions/home-workouts";
import Link from "next/link";
import { ArrowLeft, Save } from "lucide-react";
import { UploadButton } from "@/utils/uploadthing";

export default function NewHomeWorkout() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const result = await createHomeWorkout(data);
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-8 flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">Adicionar Treino em Casa</h1>
          <p className="text-zinc-400">Insira os dados da aula e faça o upload do vídeo.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 bg-zinc-900 border border-zinc-800 p-8 rounded-2xl">
        <div className="space-y-2">
          ...
          <input
            name="title"
            required
            placeholder="Ex: HIIT Intenso Corpo Todo - 30 Minutos"
