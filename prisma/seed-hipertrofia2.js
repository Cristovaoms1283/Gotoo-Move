...
async function main() {
  ...
  const createExercisesParams = (exercisesStrArray) => {
  ...
  // Ajustando os params com sets/reps corretos
  const paramsA = createExercisesParams(fichaA_Exercises);
  // O elíptico é diferente
  paramsA[paramsA.length - 1].sets = '1';
  paramsA[paramsA.length - 1].reps = '20 min';
